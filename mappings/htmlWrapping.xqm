xquery version '3.0' ;
module namespace instin.mappings.htmlWrapping = 'instin.mappings.htmlWrapping' ;
...
import module namespace instin.mappings.teiInstin2html = 'instin.mappings.teiInstin2html' at 'teiInstin2html.xqm' ; 

declare namespace html = 'http://www.w3.org/1999/xhtml' ;

declare default function namespace 'instin.mappings.htmlWrapping' ;
...
declare function render($queryParams as map(*), $outputParams as map(*), $value as node()* ) as item()* {
  ...
  return 
    if ($xquery) 
      then instin.mappings.teiInstin2html:entry($value, $options)
    else if ($xsl) 
